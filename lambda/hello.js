...
let handler = exports.handler = (() => {
  var _ref = _asyncToGenerator(function* (event, context, callback) {
    ...
    const body = yield getPage({ start_date_range: '2018-03-24T00:00:00' });
...
let getPage = (() => {
  var _ref2 = _asyncToGenerator(function* ({ start_date_range }) {
    const paramsObject = {
      lat: 37.771707,
      lon: -122.405377,
      radius: 5,
...
var convert = __webpack_require__(24).convert;
var bodyStream = __webpack_require__(46);
var PassThrough = __webpack_require__(11).PassThrough;
var FetchError = __webpack_require__(19);
...
var realFetch = __webpack_require__(21);
...
var iconvLite = __webpack_require__(25);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(14).concat(__webpack_require__(17)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(14).concat(__webpack_require__(17)) },
        gb18030: function() { return __webpack_require__(39) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(18).concat(__webpack_require__(41)) },
