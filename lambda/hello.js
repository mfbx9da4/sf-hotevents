...
var bodyStream = __webpack_require__(40);
...
__webpack_require__(41).inherits(FetchError, Error);
...
const _fetch = __webpack_require__(14);
...
var iconvLite = __webpack_require__(19);
...
var bomHandling = __webpack_require__(20),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(21); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(8).concat(__webpack_require__(35)) },
